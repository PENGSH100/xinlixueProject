...
import com.xinlixue.one.service.XinLiXue2BService;
 ...
 */
@Controller
@RequestMapping("/xinlixue/2B/")
public class XinLiXue2BController {
    @Autowired
    ...
    public HttpResponseResult<JSON> getCount(@RequestBody String bodyJson) {
        ...
        try {
            ...
            ResultSetEntity resultSetEntity=xinLiXue2BService.getCount(name,count);
    ...
    public HttpResponseResult<JSON> saveResult(@RequestBody String bodyJson) {
        ...
        try {
            ...
            xinLiXue2BService.saveResult(saveResultArg);
    ...
    public HttpResponseResult<JSON> getTimesResult(@RequestBody String bodyJson) {
        ...
        try {
            ...
            SaveResultArg saveResultArg= JSON.parseObject(bodyJson, SaveResultArg.class);
            Integer res=xinLiXue2BService.getTimesResult(saveResultArg.getSub(),saveResultArg.getTimes());
    ...
    public HttpResponseResult<JSON> login(@RequestBody String bodyJson) {
        ...
        try {
            ...
            xinLiXue2BService.login(userEntityArg);
        }catch (Exception e){
